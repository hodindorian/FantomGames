    ...
    return Scaffold(
      body: Container(
        ...
        child: Stack(
              ...
              children: <Widget>[
                ...
                Positioned(
                  ...
                  child: InkWell(
                    onTap: () {
                      setState(() {
                        CreateOrJoinRoomScreen.isSuccessOpened = !CreateOrJoinRoomScreen.isSuccessOpened;
                      });
                    },
                    child: Padding(
                      ...
                      child: Row(
                        children: [
                          Icon(
                            CreateOrJoinRoomScreen.isSuccessOpened ? Icons.cancel : Icons.inventory_sharp,
                            color: Colors.white,
          ...
          if (CreateOrJoinRoomScreen.isSuccessOpened)
            Positioned(
