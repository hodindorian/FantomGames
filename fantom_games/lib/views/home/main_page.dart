          ...
          builder: (context, orientation) {
            return Stack(
              children: <Widget>[
                ...
                ...generatePositionedWidgets(3,['assets/games/tictactoe_logo.png', 'assets/games/battleship.png', 'assets/games/tictactoe_logo.png'],[const CreateOrJoinRoomScreen(), const CreateOrJoinRoomScreenBattleShip(), const MainPage(title: ''), const MainPage(title: '')],['Morpion', 'Bataille Navale', 'Texte 3'],context),
                Positioned(
