...
class CreateOrJoinRoomScreenBattleShip extends StatefulWidget {
  static String routeName = '/main-menu';
  static bool isSuccessOpened = false;

  const CreateOrJoinRoomScreenBattleShip({super.key});

  @override
  CreateOrJoinRoomScreenBattleShipState createState() => CreateOrJoinRoomScreenBattleShipState();
}

class CreateOrJoinRoomScreenBattleShipState extends State<CreateOrJoinRoomScreenBattleShip> {
  ...
  void createRoom(BuildContext context) {
    Navigator.push(context, MaterialPageRoute(
        builder: (context) => const LoadingBattleShip()
    ));
  }
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      image: const DecorationImage(
                        image: AssetImage('games/battleship.png'),
                        fit: BoxFit.fill,
                      ),
                    ),
                  ),
